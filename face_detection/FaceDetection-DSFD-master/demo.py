...
parser.add_argument('--img_root', default='./5609.jpg', help='Location of test images directory')
...
def test_oneimage():
    ...
    net.load_state_dict(torch.load(args.trained_model, map_location={'cuda:0': 'cpu'}))
    #net.cuda()
    ...
    # load data
    path = args.img_root
    img_id = str(args.img_root).split('/')[-1].split('.')[0]
